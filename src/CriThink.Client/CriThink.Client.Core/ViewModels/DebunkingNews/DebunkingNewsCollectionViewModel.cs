...
{
    public class DebunkingNewsCollectionViewModel : BaseViewModel, IDisposable
    {
        ...
        public DebunkingNewsCollectionViewModel(IMvxNavigationService navigationService, IDebunkingNewsService debunkingNewsService, IMvxMessenger messenger)
        {
        ...
        private Task DoDebunkingNewsSelectedCommand(DebunkingNewsGetResponse selectedResponse)
        {
            return _debunkingNewsService.OpenDebunkingNewsInBrowser(selectedResponse.NewsLink);
        }
