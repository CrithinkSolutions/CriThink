...
namespace CriThink.Server.Domain.Repositories
{
    public interface IUserRepository : IRepository<User>
    {
        ...
        /// <summary>
        /// Add basic claims to the given user
        /// </summary>
        /// <param name="user">User</param>
        /// <returns></returns>
        Task<IdentityResult> AddClaimsToUserAsync(User user);

        /// <summary>
        /// Add basic claims to the given admin user
        /// </summary>
        ...
        Task<User> FindUserAsync(string value, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        /// <param name="user">User</param>
        /// <returns>The token in base64</returns>
