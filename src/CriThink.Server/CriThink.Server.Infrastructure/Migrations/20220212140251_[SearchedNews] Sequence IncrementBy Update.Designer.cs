...
namespace CriThink.Server.Infrastructure.Migrations
{
    ...
    [Migration("20220212140251_[SearchedNews] Sequence IncrementBy Update")]
    partial class SearchedNewsSequenceIncrementByUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("sequence_searchednews");
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.DebunkingNews", b =>
                {
                    ...
                    b.ToTable("debunking_news", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.DebunkingNewsCountry", b =>
                {
                    ...
                    b.ToTable("debunking_news_countries", (string)null);
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.DebunkingNewsLanguage", b =>
                {
                    ...
                    b.ToTable("debunking_news_languages", (string)null);
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.DebunkingNewsPublisher", b =>
                {
                    ...
                    b.ToTable("debunking_news_publishers", (string)null);
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.DebunkingNewsTriggerLog", b =>
                {
                    ...
                    b.ToTable("debunking_news_trigger_logs", (string)null);
                });

            modelBuilder.Entity("CriThink.Server.Domain.Entities.EmailSendingFailure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_email_sending_failures");

                    b.ToTable("email_sending_failures", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.NewsSourceCategory", b =>
                {
                    ...
                    b.ToTable("news_source_categories", (string)null);
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.NewsSourcePostQuestion", b =>
                {
                    ...
                    b.ToTable("news_source_post_questions", (string)null);
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.SearchedNews", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("id")
                        .HasDefaultValueSql("nextval('\"sequence_searchednews\"')");

                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<long>("Id"), "sequence_searchednews");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_searched_news");

                    b.HasIndex("Link")
                        .HasDatabaseName("ix_searched_news_link");

                    b.ToTable("searched_news", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.UnknownNewsSource", b =>
                {
                    ...
                    b.ToTable("unknown_news_sources", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.UnknownNewsSourceNotification", b =>
                {
                    ...
                    b.ToTable("unknown_news_source_notifications", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.UserSearch", b =>
                {
                    ...
                    b.Property<long?>("SearchedNewsId")
                        .HasColumnType("bigint")
                        .HasColumnName("searched_news_id");

                    b.Property<string>("SearchedText")
                        .HasColumnType("text")
                        .HasColumnName("searched_text");
                    ...
                    b.HasIndex("SearchedNewsId")
                        .HasDatabaseName("ix_user_searches_searched_news_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_searches_user_id");

                    b.ToTable("user_searches", (string)null);
                });
            ...
            modelBuilder.Entity("CriThink.Server.Domain.Entities.UserSearch", b =>
                {
                    b.HasOne("CriThink.Server.Domain.Entities.SearchedNews", "SearchedNews")
                        .WithMany()
                        .HasForeignKey("SearchedNewsId")
                        .HasConstraintName("fk_user_searches_searched_news_searched_news_id");
