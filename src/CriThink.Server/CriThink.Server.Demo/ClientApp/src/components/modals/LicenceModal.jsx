    ...
    render() {
        return (
            <Modal isOpen={this.props.dialogOpen} centered>
                ...
                <ModalBody>
                    <p>
                        Font Awesome Free is free, open source, and GPL
                    ...
                    <p>
                        <b>Icons: CC BY 4.0 License</b> (
                        <a href="https://creativecommons.org/licenses/by/4.0/">
                            https://creativecommons.org/licenses/by/4.0/
                        </a>
                        ) In the Font Awesome Free download, the CC BY 4.0
                        license applies to all icons packaged as SVG and JS file
                        types.
                    </p>
                </ModalBody>
                <ModalFooter>
